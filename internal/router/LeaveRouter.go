...
func SetupLeaveRoutes(router fiber.Router, app *app.App) {
	...
	leaveService := service.NewLeaveService(*leaveRequestRepo, *leaveBalanceRepo, *employeeRepo)
	...
	leaveRoutes.Get("/genereateLeaveBalance", leaveHandler.GenerateLeaveBalance)
}
